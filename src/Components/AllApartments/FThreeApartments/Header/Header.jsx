    ...
    <div>
      <div className="textCenter">
        <div className="f3HighStandingBack">
          ...
          >
            <h1 className="ltr:tracking-widest ">{t("f3_header")}</h1>
          </motion.div>
        </div>
      </div>
          ...
          >
            <div className="flex flex-col items-center justify-between md:flex-row">
              <div className="md:w-1/4">
                <h2>{t("f3_header_two")}</h2>
              </div>
              <div className="justify-between mt-12 md:mt-0 textCenter">
                <div className="flex">
                  <div>
                    <h6>{t("f3_price")}</h6>
                    <h1 className="text-2xl">{t("f3_price_header")}</h1>
                  </div>
                  <div className="md:ltr:ml-24 md:ltr:pl-24 md:ltr:border-l-secondColor md:ltr:border-l-2 md:rtl:mr-24 md:rtl:pr-24 md:rtl:border-r-secondColor md:rtl:border-r-2 ">
                    <h6>{t("f3_space")}</h6>
                    <h1 className="text-2xl">{t("f3_space_header")}</h1>
                  </div>
                </div>
              </div>
            </div>
